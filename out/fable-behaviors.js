define(["exports", "fable-core", "PIXI"], function (exports, _fableCore, _PIXI) {
  "use strict";
  ...
  _fableCore.Util.setInterfaces(State.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Fable-behaviors.State");
  ...
  _fableCore.Util.setInterfaces(RenderingContext.prototype, [], "Fable-behaviors.RenderingContext");
  ...
  function updateLoop(fps) {
    ...
    var onLoadComplete = function onLoadComplete(unitVar0) {
    ...
    var updateLoop = function updateLoop(dt) {
      window.requestAnimationFrame(function (delegateArg0) {
        updateLoop(delegateArg0);
      });
      state = update(state);
